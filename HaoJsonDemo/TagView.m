...
@interface TagView  () <UITextViewDelegate>
...
- (void)layoutInputAndScroll
{
    ...
    _inputView.layer.cornerRadius = TAG_RADIUS;//_inputView.frame.size.height * 0.3f;
    _inputView.backgroundColor = [UIColor clearColor];
    _inputView.textColor = _tagBackgroundColor;

    //reassign scrollview content size!
